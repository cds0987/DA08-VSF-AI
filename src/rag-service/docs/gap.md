...
| 16 | Parser (MarkItDown + OCR/vision), I/O guard | parser.md, ingestion §3 | ✅ Có `Parser`/`ArtifactStore` contract + local adapter; có allow-list `SOURCE_ROOT`, chặn path traversal, size-before-read, và guard `ARTIFACT_ROOT` | ✅ |
