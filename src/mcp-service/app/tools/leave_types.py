...
# NOTE(build): tool này được merge ở 38a7f8e nhưng các run sau fail (gate đỏ) -> image
# mcp-service vẫn chưa build kèm. Đụng file để build-push ở deploy này (retry sau khi
# e2e hybrid-search được nới gate).
