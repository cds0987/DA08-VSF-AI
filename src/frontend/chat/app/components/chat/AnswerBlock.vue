...
<template>
  <div class="overflow-hidden rounded-2xl bg-transparent">
    ...
    <div class="flex items-center gap-1 px-5 py-2">
      <button
        class="rounded-md p-1.5 text-slate-500 transition-colors hover:bg-slate-100 dark:text-muted-foreground dark:hover:bg-white/5"
        title="Copy"
      ...
      <button
        ...
        :class="cn(
          'rounded-md p-1.5 text-slate-500 transition-colors hover:bg-slate-100 dark:text-muted-foreground dark:hover:bg-white/5 disabled:opacity-40',
