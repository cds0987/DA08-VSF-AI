...
<template>
  <div class="mx-auto max-w-[860px]">
    <form
      ...
      :class="cn(
        'flex w-full rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-lg focus-within:border-blue-400/50 dark:focus-within:border-blue-500/50 focus-within:ring-2 focus-within:ring-blue-100 dark:focus-within:ring-blue-900/30',
    ...
    >
      <textarea
        ...
        :class="cn(
          'max-h-[200px] w-full resize-none bg-transparent text-[16px] text-slate-800 dark:text-slate-100 outline-none placeholder:text-slate-400 dark:placeholder:text-slate-500',
          isMultiline ? 'min-h-[60px] px-4 pb-2 pt-4' : 'min-h-[36px] flex-1 px-3 py-2',
        )"
      />
      <div :class="cn(isMultiline && 'flex justify-end border-t border-slate-50 dark:border-slate-800 p-2')">
        <button
          type="submit"
          ...
          :class="cn(
            ...
            input.trim() && !isProcessing
              ? 'bg-purple-600 dark:bg-purple-500 text-white shadow-lg shadow-purple-500/20 hover:bg-purple-700 dark:hover:bg-purple-600'
