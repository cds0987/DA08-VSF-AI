-- ─────────────────────────────────────────────────────────────────────────
-- seed_doc.sql — schema + bảng cho document-service (doc_db).
-- document-service KHÔNG tự create_all/alembic (xem infra/localtest/README cũ) ->
-- phải tạo tay. Chạy bằng psql trong one-shot `seed-doc` lúc dựng stack e2e.
-- Idempotent (IF NOT EXISTS) -> chạy lại vô hại.
-- ─────────────────────────────────────────────────────────────────────────
