# -*- coding: utf-8 -*-
"""
Test 3 follow-up questions on production to diagnose why sources differ between turns.

Q1: "HR cần làm công việc gì"          → initial RAG search
Q2: "Các tài liệu trên là gì vậy"      → follow-up: same docs as Q1?
Q3: "Các tài liệu trong câu hỏi 'HR cần làm công việc gì' được nhắc đến là gì"
"""
import asyncio
import json
import sys
...
QUESTIONS = [
    "HR cần làm công việc gì",
    "Các tài liệu trên là gì vậy",
    "Các tài liệu trong câu hỏi 'HR cần làm công việc gì' được nhắc đến là gì",
]
...
async def main():
    async with httpx.AsyncClient(timeout=120, follow_redirects=True) as http:
        ...
        print("=" * 70)
        print("Test: HR sources follow-up questions (same conversation)")
        print("=" * 70)
        ...
        for i, question in enumerate(QUESTIONS, 1):
            ...
            if done:
                ...
                if sources:
                    ...
                    for s in sources:
                        print(f"    - {s.get('document_name', '?')!r}  score={s.get('score', '?'):.3f}")
                else:
                    print("  Sources: NONE returned to frontend")
