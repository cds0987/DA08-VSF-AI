...
| OCR cho PDF scan | ⚠️ | ✅ | ❌ | ❌ | ❌ | ✅ (Gemini Vision) |
...
**→ Giải pháp: Gemini Vision API, chuyên biệt cho tiếng Việt.**
...
**→ Giải pháp: Self-hosted, open-source stack (FastAPI + Qdrant + PostgreSQL), chỉ trả tiền API (OpenAI, Gemini).**
