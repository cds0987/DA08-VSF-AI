...
| **DevOps** | Trần Hữu Gia Huy | (Ngày 1–2, song song SA) Dockerfile mỗi service + `docker-compose.yml` skeleton + CI pipeline skeleton. Provision **Cloud SQL** (5 db: user/doc/query/mcp/langfuse), **Cloud Storage (GCS)**, container **NATS/Qdrant/Redis**. | — |
